...
You must also migrate your repository mirrors to the new `landscape-debarchive` snap as part of your upgrade to 26.04 LTS. See the {ref}`dedicated guide <how-to-migrate-repository-mirrors-to-debarchive>` for instructions on how to do this.
